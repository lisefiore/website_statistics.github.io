...
* Students must explore data analysis including **summary statistics** and **relevant visualizations** that reveal trends in the data. In order to huide the students, at least *three visualizations* will be required.
