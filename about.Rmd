...
1. *Lab report 1*: [**Distribution**](Session-7-pervious-pavement.pdf). 

2. *Lab report 2*: [**Stochastic Rainfall Simulation**](Session-8-rainfall-simulation.pdf). 

3. *Lab report 3*: [**Hypothesis testing**](Session-9-hypothesis-testing.pdf). 

4. *Lab report 4*: [**Linear regression**](Session-10-linear-regression.pdf). 